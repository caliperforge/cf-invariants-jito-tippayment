...
pub mod jito_tip_payment {
    ...
    pub fn change_block_builder(
        ...
        // PLANTED BUG (cf-invariants-jito-tippayment, block_builder_commission_pct_bounds):
        //   Upstream rejects commission values > 100 here:
        //
        //       require_gte!(100, block_builder_commission, TipPaymentError::InvalidFee);
        //
        //   This planted variant drops that check. The instruction then
        //   commits any caller-supplied commission value into
        //   Config.block_builder_commission_pct unconditionally, which
        //   downstream Fees::calculate treats as a percentage and lets
        //   block-builder fees exceed the total tip amount.
        //
        //   This surfaces as a violation of the
        //   `invariant_block_builder_commission_pct_bound` fixture, which
        //   reads Config.block_builder_commission_pct after each
        //   successful call and asserts it is <= 100.
        // require_gte!(100, block_builder_commission, TipPaymentError::InvalidFee);
